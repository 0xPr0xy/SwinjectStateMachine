#
# Be sure to run `pod lib lint SwinjectStateMachine.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'SwinjectStateMachine'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwinjectStateMachine.'
